---
name: nan-gai-nv-gao
description: Use when the user asks to reverse gender roles in a Chinese relationship, Ryan-style, Douyin, emotional口播, 两性博弈, or 男拿捏女 script by using the configured Gemini API in an isolated new-chat request, sending a fixed Ryan female-emotional-mentor prompt, and rewriting it into a TTS-ready female-audience script about reading male psychology.
---

# Gemini Ryan Gender Reversal
...
5. If the output contains Markdown headings, bullets, tables, bracketed stage directions, or obvious male-audience residue, send a second API request with the prior output and ask Gemini to revise until it is clean.
...
```text
【角色设定】
你是一个顶级的短视频情感口播文案操盘手。你在文案中的出镜人设是：“女性情感导师Ryan”。
...
加入男性背叛感：在合适的地方加入类似“作为男人，我给你们交个底/说句实话”的句式，增强Ryan这个男导师设定的说服力。
...
中插引流：在文案进行到一半，用户痛点最深（比如女生经常被当兄弟、被低成本持有、对方不愿意付出、被男人牵着鼻子走等）的地方，自然植入一段引导咨询（如：“说到这里停一下，如果你现在...直接去主页进入我们的姐妹群，Ryan来帮你做个针对性的技巧重塑”）。
结尾引流：在给出部分干货后，强调靠自己摸索很难，再次引导进粉丝群（如：“直接主页进入姐妹群”）。
固定结尾：“我是Ryan，专注于让姐妹们在最短时间内补齐认知差，快速拿到该有的结果，感谢观看。”
...
- The visible persona is Ryan speaking as a male insider serving women, despite the role label “女性情感导师Ryan”.
...
- The final sentence is exactly: `我是Ryan，专注于让姐妹们在最短时间内补齐认知差，快速拿到该有的结果，感谢观看。`
