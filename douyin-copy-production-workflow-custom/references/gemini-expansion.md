...
案例的主角是Gary的咨询客户、学员
案例形式可以根据【原文】灵活变化，不要每篇都写成同一种固定模板。可以是聊天误判案例、约会推进案例、冷淡翻盘案例、分手挽回案例、暧昧拉扯案例、长期关系失衡案例、朋友圈展示案例、相亲筛选案例、职场社交关系案例、跨城市异地关系案例、婚恋谈判案例、前任重启案例等，但全文仍然只能围绕一个主案例展开，不能写成多个案例合集。
案例冲突必须从【原文】最核心的心理机制、技巧、信号、步骤或情绪矛盾里长出来。案例形式可以变化，但不能为了变化形式，把原文主题替换成泛关系场景。比如原文讲补偿心理，案例就必须围绕补偿心理展开；原文讲肢体信号，案例就必须围绕肢体信号识别和推进展开；原文讲聊天技巧，案例就必须围绕聊天技巧在真实互动里的使用展开。
...
可以从原文最有冲突感的技巧、信号或机制切入，再带出这个学员在真实场景里怎么遇到、怎么判断、怎么操作、怎么得到反馈。
可以讲双方互动怎么自然变化，也可以讲学员如何按原文技巧一步步推进，边推进边解释女方潜意识为什么会这样反应。
...
案例重点不是讲故事，而是借这个故事拆出【原文】里的技巧、信号、机制、误判、测试、筛选、价值变化和位置变化。
每推进一个情节，都必须立刻跟上分析。
不要一口气讲完整个故事再统一分析。
必须边讲边拆，边拆边推进。
可以使用【原文】里的技巧、步骤、信号和判断标准来推动案例，不要把案例写成脱离原文的泛关系故事。
