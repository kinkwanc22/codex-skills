...
“好，我们直接进入正题。”之后，正文首段只能承担一个主要任务：扎中一个核心痛点、直接抛出一个反常识判断，或者立刻进入案例冲突，三者选一，不要在同一段全部完成。
...
这一规则只限制正文首段的臃肿，不要求每篇都用痛点开场；选择案例、冲突或结论开场时，仍按本篇最合适的动态结构自然推进。
...
正文首段也必须服从结构去同质化：可以从痛点、案例动作、冲突现场或狠判断切入，但只选一个主入口。尤其是痛点式首段，不要连续堆“条件不够、聊天失误、需求感、价值判断、女人反馈、解决方向”等多层解释；把后续层次留给正文展开。

当本篇结构计划明确选择“共情式”或“批判式”正文首段时，可以写成一个完整大段，不受普通痛点式首段 80-140 个中文字符的默认范围限制。这个大段不能只做现象说明，也不能一边批判一边立刻替对方找理由。它要从本篇母题独有的不对称切入，把女人从这套互动里拿走的情绪、虚荣、选择或退路，与男人被迫承担的判断、推进、名誉、自我怀疑或错失风险讲清楚，让男性观众感觉自己的具体委屈被说中，再直接扣回本篇真正要拆的机制。
...
写作前在内部回答四个问题即可，不要把问题或固定顺序写进正文：本篇里她具体拿走了什么；她把什么责任或风险留给男人；男人为什么无论进退都容易被判错；这个委屈如何只用一两句自然转回本篇独有机制。不同选题必须更换场景、利益矛盾和回扣方式，禁止把同一段性别控诉换几个名词后重复使用。
