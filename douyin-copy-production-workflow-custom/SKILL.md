...
- `references/3.1-balanced-soft-fan-group-layer.md`: read after every accepted 3.1 Gemini body and before Word export. By default, replace the prompt-generated large mid/end CTAs with article-native balanced soft placements while preserving the exact fixed ending; explicit user CTA instructions override this layer.
