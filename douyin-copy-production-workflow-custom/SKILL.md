...
Build each UTF-8 prompt file with the full current Gemini instruction block from `references/gemini-expansion.md`, followed immediately by the original source text wrapped as `【原文开始】...【原文结束】`.
