#!/usr/bin/env python3
"""Upscale local Codex GPT Image 2 results on win-codex and return exact 2K files."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="把本地 Codex GPT Image 2 图片交给 win-codex RTX GPU 超分，并保存为精确 2K。"
    )
    parser.add_argument("images", nargs="*", type=Path, help="一个或多个 GPT Image 2 原图")
...
def main() -> int:
    ...
    for index, source_arg in enumerate(args.images, start=1):
        ...
        record: dict[str, object] = {
            ...
            "pipeline": "CodexGPTImage2_WindowsGPU超分2K",
