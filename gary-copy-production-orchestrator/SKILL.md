...
- Read `huanxin` for topic/knowledge route design and mechanism deduplication.
...
- Do not reuse the generic body opening skeleton `女人拿走了什么 / 你留下了什么 / 全砸在你身上 / 卡在这个死局里` across articles. Choose one topic-native entry: a concrete scene, one hard judgment, one case action, or one immediate conflict.
