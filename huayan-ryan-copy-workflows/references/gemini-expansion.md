...
所有人设、口吻标签、CTA品牌和固定片尾一律使用Ryan。当前长文固定最后一句为：我是花研Ryan，我们粉丝群里见，感谢观看
...
动态CTA+固定Slogan：“我是花研Ryan，我们粉丝群里见，感谢观看”
...
Before creating a new pre-transplanted source for the same manuscript, inspect `work/huayan_ryan_31_routes.json` if it exists. Avoid all prior `avoid_next_time` items for that same source/title.
...
- final draft reuses a prior 3.1 route for the same source from `work/huayan_ryan_31_routes.json`;
...
结尾要先自然收束全文，再植入粉丝群动态CTA，最后一句必须是：我是花研Ryan，我们粉丝群里见，感谢观看。
...
- End with exactly the fixed slogan: `我是花研Ryan，我们粉丝群里见，感谢观看`
...
- Output lacks the required fixed ending. For current Ryan directions require the exact final sentence `我是花研Ryan，我们粉丝群里见，感谢观看` and reject any occurrence of `内部群`.
